            ...
            <div className="mt-10">
              ...
              <div className="mt-6">
                <button
                  ...
                  className="flex w-full items-center justify-center gap-3 rounded-lg bg-gray-900/50 backdrop-blur-xl px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-700 hover:bg-gray-800/50 focus-visible:ring-2 focus-visible:ring-blue-600"
                >
